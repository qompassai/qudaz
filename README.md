<!-------------/qompassai/qudaz/README.md ---------------->
<!-- -------------Qompass AI Qudaz ----------------------->
<!-- Copyright (C) 2025 Qompass AI, All rights reserved -->
<!-------------------------------------------------------->

<h2> Qudaz: Qompass AI Cuda for Zig </h2>

<h3> Quality Cuda Library for Zig </h3>
This library helps to interact with NVIDIA GPUs from zig. Provides high level interface to communicate with GPU. It can detect cuda installation and link to a project's binary on Linux/MacOS. Check [Customization](https://github.com/qompassai/qudaz/tree/main#Customization) to give cuda manual path.
...
<br>
<a href="https://ziglang.org/documentation/">
  <img src="https://img.shields.io/badge/Zig_Documentation-blue?style=flat-square" alt="Zig Documentation">
</a>
<a href="https://github.com/topics/zig-tutorial">
  <img src="https://img.shields.io/badge/Zig_Tutorials-green?style=flat-square" alt="Zig Tutorials">
</a>
<br>
<a href="https://doi.org/10.5281/zenodo.16169756"><img src="https://zenodo.org/badge/DOI/10.5281/zenodo.16169757.svg" alt="DOI"></a>
