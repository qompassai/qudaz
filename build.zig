...
pub fn build(b: *std.Build) !void {
    ...
    ////////////////////////////////////////////////////////////
    //// QudaZ Module
    const cudaz_module = b.addModule("qudaz", .{ .root_source_file = b.path("./src/lib.zig") });
    ...
    test_blk: {
        ...
        // Hack for identifying if the current root is qudaz project, if not don't register tests.
        if (std.mem.indexOf(u8, test_file_contents, ".name = .qudaz") == null) {
            break :test_blk;
        }
